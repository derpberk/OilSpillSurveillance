...
if __name__ == '__main__':
    ...
    map = (1-np.genfromtxt('plantilla2.csv')).astype(int)

    planner = AStarPlanner(map, 1, 1)

    path = np.asarray(planner.planning([233, 383], [105,548])).T
